...
<body>
					...
					<nav class="main-nav">
						<ul class="clear-fix">
							<li>
								...
								<!-- sub menu -->
								<ul>
									<li><a href="index.html" class="active">First-Page</a></li>
								</ul>
								<!-- / sub menu -->
							</li>
							<li class="megamenu">
								...
								<ul class="clear-fix">
									<li><div class="header-megamenu">Pages</div>
										<ul>
											...
											<li><a href="page-full-width.html">What we Do ?</a></li>
											<li><a href="page-faq.html">Forum</a></li>
									...
									<li><div class="header-megamenu">Blog</div>
										<ul>
											<li><a href="blog-default.html">Posts</a></li>
										</ul>
										<img src="http://placehold.it/250x150" alt>
									</li>
								</ul>
	...
	<div class="tp-banner-container">
	 ...
	 data-transform_out="opacity:0;s:300;s:1000;" data-start="400">
						...
						<a href="page-register.html" class="cws-button border-radius">Join us <i class="fa fa-angle-double-right"></i></a>
					</div>
   				</li>
   				<li data-masterspeed="700">
			...
			<div class="grid-row clear-fix">
				...
				<div class="grid-col-row">
					<div class="grid-col grid-col-4">
						...
						<div class="course-item">
							<div class="course-hover">
								<img src="pic/alg.png" data-at2x="pic/alg.png" alt>
								<div class="hover-bg bg-color-2"></div>
								<a href="">Learn More</a>
							</div>
							<div class="course-name clear-fix">
								<span class="price">25.Dt</span>
							<h3><a href="#">Algebra Basics</a></h3>
								</div>
							<div class="course-date bg-color-2 clear-fix">
								<div class="day"><i class="fa fa-calendar"></i>7 January</div><div class="time"><i class="fa fa-clock-o"></i>At 2:00 pm</div>
								<div class="divider"></div>
								<div class="description">The basic operations covered in algebra are addition, subtraction, multiplication, and division</div>
							</div>
						</div>
						<!-- / course item -->
					</div>
					<div class="grid-col grid-col-4">
						...
						<div class="course-item">
							<div class="course-hover">
								<img src="pic/clang.png" data-at2x="pic/clang.png" alt="">
							...
							<div class="course-date bg-color-3 clear-fix">
								<div class="day"><i class="fa fa-calendar"></i>10 January</div><div class="time"><i class="fa fa-clock-o"></i>At 4:00 pm</div>
								<div class="divider"></div>
								<div class="description">The C Programming Language is a computer programming book written by Brian Kernighan and Dennis Ritchie</div>
							</div>
						</div>
						<!-- / course item -->
					</div>
					<div class="grid-col grid-col-4">
						...
						<div class="course-item">
							<div class="course-hover">
								<img src="pic/ht.png" data-at2x="pic/ht.png" alt="">
								<div class="hover-bg bg-color-5"></div>
								<a href="">Learn More</a>
							</div>
							<div class="course-name clear-fix">
								<span class="price">20.dt</span>
							<h3><a href="#">Html/JS/CSS</a></h3>
								</div>
							<div class="course-date bg-color-5 clear-fix">
								<div class="day"><i class="fa fa-calendar"></i>12 January</div><div class="time"><i class="fa fa-clock-o"></i>At 6:30 pm</div>
								<div class="divider"></div>
								<div class="description">HTML,CSS,and JavaScript are acronyms that come up over and over again when it comes to web development.</div>
							</div>
						</div>
						<!-- course item -->
					</div>
			...
			<div class="grid-row clear-fix">
				<div class="grid-col-row">
					<div class="grid-col grid-col-4 clear-fix">
						...
						<a href="" class="cws-button bt-color-3 border-radius alt icon-left float-left">Learn More<i class="fa fa-angle-right"></i></a>
					</div>
					<div class="grid-col grid-col-5">
						<a href="" class="service-icon"><i class="flaticon-pie"></i>Mathematics</a>
						<a href="" class="service-icon"><i class="flaticon-website"></i>Web</a>
						<a href="" class="service-icon"><i class="flaticon-web-programming"></i>Programming</a>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="grid-col-row clear-fix">
					...
					<div class="grid-col grid-col-4 alt">
						<div class="counter-block">
							...
							<div class="counter" data-count="240">0</div>
				...
				<div class="grid-col-row">
					<div class="grid-col grid-col-4">
						<div class="community color-1">
							...
							<div class="community-logo">
								<a href="page-faq.html"> <i class="flaticon-calendar"></i></a>
							</div>
					...
					<div class="grid-col grid-col-4">
						<div class="community">
							<h3>Blog</h3>
							<div class="community-logo">
								<a href="blog-default.html"><i class="flaticon-pencil"></i></a>
							</div>
							<div class="info-block">
							</div>
						</div>
					...
					<div class="grid-col grid-col-4">
						<div class="community color-2">
							...
							<div class="community-logo">
								<a href="courses-list.html"><i class="flaticon-book1"></i></a>
							</div>
							<div class="info-block">
							</div>
						</div>
			...
			<div class="grid-row">
				...
				<div class="owl-carousel testimonials-carousel">
					<div class="gallery-item" style="position: relative; left: 376px;">
						<div class="quote-avatar-author clear-fix"><img src="http://placehold.it/94x94" data-at2x="http://placehold.it/94x94" alt=""><div class="author-info">Walid B.Hsouna<br><span>Writer</span></div></div>
					</div>
					<div class="gallery-item" style="position: relative; left: 376px;">
						<div class="quote-avatar-author clear-fix"><img src="http://placehold.it/94x94" data-at2x="http://placehold.it/94x94" alt=""><div class="author-info">Rym Mrayhi<br><span>Writer</span></div></div>
					</div>
					<div class="gallery-item" style="position: relative; left: 376px;">
						<div class="quote-avatar-author clear-fix"><img src="http://placehold.it/94x94" data-at2x="http://placehold.it/94x94" alt=""><div class="author-info">Md.idriss ElBessi<br><span>Writer</span></div></div>
					</div>
					<div class="gallery-item" style="position: relative; left: 376px;">
						<div class="quote-avatar-author clear-fix"><img src="http://placehold.it/94x94" data-at2x="http://placehold.it/94x94" alt=""><div class="author-info">Amal Achour<br><span>Writer</span></div></div>
					</div>
					<div class="gallery-item" style="position: relative; left: 376px;">
						<div class="quote-avatar-author clear-fix"><img src="http://placehold.it/94x94" data-at2x="http://placehold.it/94x94" alt=""><div class="author-info">Amina Attafi<br><span>Writer</span></div></div>
					</div>
				</div>
			</div>
		</section>
