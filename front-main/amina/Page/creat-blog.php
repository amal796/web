<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		{
			//save to database
			$insert = $con->prepare("insert into blog (name,photo,description,text,creator) values ('$name','$photo','$description','$text','$creator')");
			$insert->execute();
								...
								<ul class="clear-fix">
									...
									<li><div class="header-megamenu">Blog</div>
										<ul>
											...
											$count=$stmt->rowCount();
											if ($count > 0) {
											echo '<li><a href="creat-blog.php" class="active">Add a blog</a></li>';
			...
			<div class="grid-col grid-col-9">
				...
				<main>
					<form method="POST">
						...
						<br>
						<label for="name">Blog Picture :</label>
						<input type="text" name="photo" placeholder="put photo link ..">
						<br>
						<label for="description">Description :</label>
						<textarea style="border:5px;" name="description" id="" cols="30" rows="10"></textarea>
						<br>
	...
	sit amet pretium tortor mattis.</p>
				...
				<section class="grid-col grid-col-4 footer-contact-form">
					...
					<form action="php/contacts-process.php" class="contact-form" method="post" novalidate="novalidate">
						...
						<p><span class="your-message"><textarea name="message" placeholder="names" cols="40" rows="5" aria-invalid="false" required></textarea></span> </p>
