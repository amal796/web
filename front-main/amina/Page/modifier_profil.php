<?php
include_once 'C:\xampp\htdocsamina\Controller\UserC.php';
include_once 'C:\xampp\htdocsamina\Controller\EtudiantC.php';
include_once 'C:\xampp\htdocsamina\Controller\FormateurC.php';
include_once 'C:\xampp\htdocsamina\config.php';
session_start();
$userC = new UserC();
                ...
                if(password_verify($password,$row['pass_word']))
                {
                    if(isset($_POST['cin']) && isset($_POST['name']) && isset($_POST['lname']) && isset($_POST['date']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['sexe']) && isset($_POST['username']))
                    {
                        if(!empty($_POST['cin']) && !empty($_POST['name']) && !empty($_POST['lname']) && !empty($_POST['date']) && !empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['sexe']) && !empty($_POST['username']))
                        {
                            ...
                            $user = new User($_POST['cin'],$_POST['name'] ,$_POST['lname'] ,$_POST['email'],$_POST['phone'],$_POST['sexe'] ,$_POST['date'] ,$_POST['username'] ,$row['pass_word'],$row['choix']);
                            if(($row['choix'] == "t"))
                            {
