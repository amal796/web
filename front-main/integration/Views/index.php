			...
			<div class="grid-row clear-fix">
				<div class="grid-col-row">
					...
					<div class="grid-col grid-col-5">
						<?php foreach($result_categorie as $row3){?>
						<a href="<?= $row3['nom_categorie'].".php"?>" class="service-icon"><i class="<?= $row3['icon_html']?>"></i><?=$row3['nom_categorie']?></a>
						<?php }?>
					</div>
				</div>
			</div>
				...
				<div class="grid-col grid-col-6">
					...
					<div class="item-instructor bg-color-<?=$i+1?>">
						<a href="page-profile.html" class="instructor-avatar">
							<img src="<?=$img_teacher[$i]['img'] ?>" data-at2x="<?=$img_teacher[$i]['img'] ?>" alt>
						</a>
						<div class="info-box">
				...
				<div class="grid-col-row">
					<div class="grid-col grid-col-4">
						<div class="community color-1">
							...
							<div class="community-logo">
								<a href="page-faq.html"> <i class="flaticon-book1"></i></a>
							</div>
					...
					<div class="grid-col grid-col-4">
						<div class="community color-2">
							...
							<div class="community-logo">
								<a href="courses-list.html"><i class="flaticon-book"></i></a>
							</div>
							<div class="info-block">
							</div>
						</div>
